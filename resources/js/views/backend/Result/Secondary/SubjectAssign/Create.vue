            ...
            <div class="card border">
                ...
                <div class="card-body p-3">
                    <div class="row g-3">
                        ...
                        <!------------ Single Input ------------>
                        <SelectCustom title="Medium" field="medium_id" :req="true" :datas="$root.global.mediums" col="3"
                            val="id" val_title="name" />
                        <!------------ Single Input ------------>
                        <SelectCustom title="Academic Class" field="academic_class_id" :req="true" :datas="classes"
                            col="3" val="id" val_title="name" />
                        <!------------ Single Input ------------>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button type="button" :disabled="$root.submit ? true : false"
                                class="btn btn-success btn-sm px-3 float-end" @click="submit()">
                    ...
                    <table class="table table-sm table-bordered table-striped mb-0">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 70px" class="text-center">Main Sub.</th>
                      ...
                      <tbody>
                            <tr v-for="(subject, key) in data.details" :key="key">
                                <td>
                                    <div class="d-flex justify-content-between">
                                        <div class="w-100 me-2">
                                            <v-select v-model="subject.subject_id" label="name"
                                                :reduce="(obj) => obj.id" :options="subjects"
                                                placeholder="--Select One--" :closeOnSelect="true" :class="validation.hasError('data.subject_id')
                                                        ? 'required'
                                                        : ''
                                                    " class="mb-2"></v-select>
                                        </div>
                                        <div class="w-100">
                                            <v-select v-model="subject.combined_subject_id" label="name"
                                                :reduce="(obj) => obj.id" :options="subjects"
                                                placeholder="--Combined Subject--" :closeOnSelect="true" :class="validation.hasError('data.combined_subject_id')
                                                        ? 'required'
                                                        : ''
                                                    "></v-select>
                                        </div>
                                ...
                                <td class="text-center">
                                    <label for="yes">
                                        <input type="radio" v-model="subject.fourth_subject" value="1" id="yes" />
                                        Yes
                                    </label>
                                    <label for="no">
                                        <input type="radio" v-model="subject.fourth_subject" value="0" id="no" />
                                        No</label>
                                </td>

                                <td class="text-center">
                                    <label for="yes">
                                        <input type="radio" v-model="subject.main_subject" value="1" id="yes" />
                                        Yes
                                    </label>
                                    <label for="no">
                                        <input type="radio" v-model="subject.main_subject" value="0" id="no" />
                                        No</label>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-between">
...
<script>
    ...
    export default {
        ...
        validators: {
            ...
            "data.academic_group_id": function (value = null) {
                return Validator.value(value).required("Academic Group is required");
            },
        },
    };
</script>
