              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {{
                        data.class_test_result.qualification
                          ? data.class_test_result.qualification.name
                          : ""
                      }}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      {{
                        data.class_test_result.department
                          ? data.class_test_result.department.name
                          : ""
                      }}
                    </td>
                  </tr>
