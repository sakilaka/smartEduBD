      ...
      >
        ...
        <template v-slot:[`action`]="row">
          <td class="action" style="width: 13%">
            ...
            <router-link
              v-if="$root.checkPermission('primaryResult.result')"
              :to="{
                name: 'primaryResult.result',
...
export default {
  ...
  async created() {
    this.setBreadcrumbs(this.model, "index", "Primary Result", addOrBack);
