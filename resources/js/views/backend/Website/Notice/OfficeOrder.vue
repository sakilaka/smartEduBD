...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      this.get_paginate_data("notice-officeOrder", this.search_data);
    },
  },
  async created() {
    this.setBreadcrumbs(this.model, "index", "Office Order", addOrBack);
    await this.get_paginate_data("notice-officeOrder", this.search_data);
  },
};
</script>