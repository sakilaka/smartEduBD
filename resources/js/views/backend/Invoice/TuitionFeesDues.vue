    ...
    <div v-if="!$root.spinner" class="col-12">
        <div class="card border">
            <div class="card-header">
                <h6 @click="search_filter = !search_filter" class="mb-0 text-uppercase cursor-pointer">
                    Search Dues Report
            ...
            <div v-show="search_filter" class="card-body">
                <div class="row g-2">
                    <form v-on:submit.prevent="asyncData" class="col-12 row my-2">
                        <!------------ Single Input ------------>
                        <SelectSearch title="Month" field="dues_month" :datas="$root.global.months" val="key"
                            val_title="name" :col="1" />
                        <!------------ Single Input ------------>
                        <SelectSearch v-if="!$root.institution_id" title="All Institution" field="institution_id"
                            :datas="$root.global.institutions" val="id" val_title="name" :req="true" />
                        <!------------ Single Input ------------>
                        <SelectSearch title="Institution Category" field="institution_category_id"
                        ...
                        <!------------ Single Input ------------>
                        <SelectSearch title="All Campus" field="campus_id"
                            :datas="campuses_filter(search_data.institution_id)" val="id" val_title="name" />
                        <!------------ Single Input ------------>
                        <SelectSearch title="All Shift" field="shift_id" :datas="shift_filter(search_data.institution_id, 'search_data')
                            " val="shift_id" val_title="shift_name" col="1" />
                        <!------------ Single Input ------------>
                        <SelectSearch title="All Medium" field="medium_id" :datas="medium_filter(search_data.institution_id, 'search_data')
                            " val="medium_id" val_title="medium_name" />

                        <div class="w-100 mt-2"></div>

                        <!------------ Single Input ------------>
                        <SelectSearch title="All Class" field="academic_class_id" :datas="class_filter(search_data.institution_id, 'search_data')
                            " val="academic_class_id" val_title="class_name" />


                        <!------------ Single Input ------------>
                        <SelectSearch title="Group" field="group_id" :datas="group_filter(search_data.institution_id, 'search_data')
                            " val="group_id" val_title="group_name" col="1" />
                        <!------------ Single Input ------------>
                        <SelectSearch title="Section" field="section_id" :datas="section_filter(search_data.institution_id, 'search_data')
                            " val="section_id" val_title="section_name" col="1" />
        ...
        <div class="card border">
            ...
            <div class="card-body">
                <base-table :data="table.datas" :columns="table.columns" :routes="{}">
                    ...
                    <template v-slot:[`dues_months`]="row">
                        <td>
                            {{ getMonthNames(row.item.dues_fees) }}
                        </td>
                    </template>
                </base-table>
            </div>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-sm table-bordered table-striped mb-0 mt-3">
                            <thead>
                                <tr>
                            ...
                            <tbody v-if="
                                student.dues_fees &&
                                Object.keys(student.dues_fees).length > 0
                            ">
...
<script>
    ...
    const tableColumns = [
        ...
        { field: 'student_roll', title: 'Roll Number' },
        ...
        { field: 'dues_months', title: 'Dues Month' },
    ...
    export default {
        ...
        methods: {
            getMonthNames(duesFees) {
                ...
                if (!duesFees || duesFees.length === 0) return '';

                return duesFees
                    .map(fee => monthMap[fee.month.padStart(2, '0')])
