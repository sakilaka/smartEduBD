...
class PrimaryResult extends ParentModel
{
    ...
    {
        return $this->hasMany(PrimaryResultDetails::class);
    }
    ...
    {
        return $this->belongsTo(Institution::class)->select('id', 'name', 'short_name', 'primary_term_marksheet');
    }
