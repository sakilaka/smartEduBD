...
class SecondaryResult extends ParentModel
{
    ...
    {
        return $this->hasMany(SecondaryResultDetails::class);
    }
    ...
    {
        return $this->belongsTo(Institution::class)->select('id', 'name', 'short_name', 'secondary_term_marksheet', 'secondary_term_marksheet_combined');
    }
