...
class CreateSecondaryClassTestResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('secondary_class_test_results', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('secondary_class_test_results');
    }
}
